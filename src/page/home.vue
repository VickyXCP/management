    ...
    <div class="home">
        ...
        <section class="data_section">
            ...
            <el-row :span="20">
                ...
                <el-col :span="4"><div class="data_list"><span class="">{{userCount}}</span>新增用户</div></el-col>
                ...
                <el-col :span="4"><div class="data_list"><span class="">{{allUserCount}}</span>注册用户</div></el-col>
